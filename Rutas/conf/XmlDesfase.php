...
$tsql= "SELECT top 1 id,telefono, SUBSTRING(latitud,0,8) as latitud, SUBSTRING(longitud,0,8) as longitud,fecha,fecha_texto FROM coordenadas where telefono='2228514481' order by id desc";
