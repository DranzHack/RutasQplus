...
<div id="map"></div>
Select unit:<select id="units"><option selected disabled hidden>-- Seleccione Una Unidad --</option></select>
...
<input id="build" type="button" value="Ver Trayecto">
<br>
Haz Click Cuando Quieras Ver Una Trayectoria
<table id="tracks">
    <thead>
    <td>Unidad</td>
    <td>Información</td>
    <td>Color</td>
    <td>Eliminar Pista</td>
    </thead>
</table>
<div id="log"></div>
...
var unit_id =  $("#units").val(),
  ...
  {
    msg("Esta wea ya se esta muestrando");
    return;
  }
