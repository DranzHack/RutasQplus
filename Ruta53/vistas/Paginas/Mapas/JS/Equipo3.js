...
*/
    ...
    Unidad21();
    window.setInterval(Unidad21,10000);
...
//Aki se grafica el market con los datos que se desean mostrar
  $.get(data,{},function(data){
      $(data).find("marker").each(function(){
          ...
          var Ubicacion=marker.attr("Direccion");
          var Id=marker.attr("Id");
          var Date=Fecha+" "+Hora;
          var html = "<b> Unidad: "+Ruta+"<br>Chofer: "+Chofer+" "+Paterno+" "+Materno+"<br>Ubicación: "+Ubicacion+"<br>Fecha: "+Fecha+" Hora:"+Hora+"<b>";
