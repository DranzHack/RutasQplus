...
*/
    ...
    Unidad1();
    window.setInterval(Unidad1,10000);
    Unidad2();
...
function Unidad1()
{
  ...
  var data = '../../conf/XmlCombi1.php?t='+timestamp;
...
function Unidad3()
{
  ...
  //Timestamp obtiene la fecha para posterios pasarlos a la ruta y asi hacer el REFRESH Del market
  var timestamp = new Date().getTime();
  var data = '../../conf/XmlCombi3.php?t='+timestamp;
...
//Aki se grafica el market con los datos que se desean mostrar
  $.get(data,{},function(data){
      $(data).find("marker").each(function(){
          ...
          //var html="<b>Unidad: "+Ruta+"<br>Chofer: "+Chofer+" "+Paterno+" "+Materno+"<br> Ubicación:"+Ub+ "<br> Fecha: "+Fecha+" Hora: "+Hora+ " </b>";
          var Date=Fecha+" "+Hora;
          var html = "<b> Unidad: "+Ruta+"<br>Chofer: "+Chofer+" "+Paterno+" "+Materno+"<br> Ubicacion: "+Ub+"<br> Fecha: "+Fecha+" Hora: "+"<b>";
...
for (var base1 in bases1) {
          ...
          var CircleBase1 = new google.maps.Circle({
            ...
            map: map,
            title:'Base1',
            text:'Somethin About Lets Go BABY',
