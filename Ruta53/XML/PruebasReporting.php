...
$tsql="
SELECT top 1 MAX (rol.SLL_IdSalidaLlegada) AS ido,com.Cb_NumeroRuta,chofer.Ch_NombreChofer,chofer.Ch_ApellidoPaterno,chofer.Ch_ApellidoMaterno,gps.Direccion,gps.Latitud,gps.Longitud,gps.Fecha,gps.Hora from Salidas_Llegadas rol inner join Cb_Combi com
...
inner join LocationGPS gps on gps.Imei=com.Cb_Imei
  where gps.Imei='12345' and gps.Fecha='$hoy' AND rol.SSL_EstadoIO='Inicio'
group by com.Cb_NumeroRuta,chofer.Ch_NombreChofer,chofer.Ch_ApellidoPaterno,chofer.Ch_ApellidoMaterno,gps.Direccion,gps.Latitud,gps.Longitud,gps.Fecha,gps.Hora
order by gps.Hora desc
...
while ($row = @sqlsrv_fetch_array($getResults,SQLSRV_FETCH_ASSOC)){
  ...
  $newnode->setAttribute("Id",$row['ido']);
